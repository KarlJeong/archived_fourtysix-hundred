...
public class WebConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(commonInterceptor).addPathPatterns("/", "/main/**", "/admin/**", "/blog/**", "/notice/**", "/v1/api/**", "/b/**")
				.excludePathPatterns("/js/**, /vendors/**");

		registry.addInterceptor(pageAuthorizeInterceptor).addPathPatterns("/", "/main/**", "/admin/**", "/blog/**", "/notice/**", "/b/**")
				.excludePathPatterns("/js/**, /vendors/**");
