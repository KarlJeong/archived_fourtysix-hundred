...
/**
 * The persistent class for the TB_ARTICLE_GENERAL_FILE database table.
 *
 */
@Entity
@Table(name = "TB_ARTICLE_GENERAL_FILE")
@NamedQuery(name = "TbArticleGeneralFile.findAll", query = "SELECT t FROM TbArticleGeneralFile t")
public class TbArticleGeneralFile implements Serializable {
