...
public class TbComAuthSpec {

    public enum SearchKey {
        AUTHCODE("authCode"), AUTHNAME("authName"), USEYN("useYn");
    ...
    public static Specification<TbComAuth> searchWithKeys(Map<SearchKey, Object> searchKeys) {
        return (Specification<TbComAuth>) ((root, query, builder) -> {
    ...
    private static List<Predicate> getPredicateWithKeyword(Map<SearchKey, Object> searchKeyword,
            Root<TbComAuth> root, CriteriaBuilder builder) {
