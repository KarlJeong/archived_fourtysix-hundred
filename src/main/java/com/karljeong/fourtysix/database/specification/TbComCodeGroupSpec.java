...
public class TbComCodeGroupSpec {

    public enum SearchKey {
        CODEGROUPNAME("codeGroupName"), CODEGROUPVALUE("codeGroupValue"), USEYN("useYn");
    ...
    public static Specification<TbComCodeGroup> searchWithKeys(Map<SearchKey, Object> searchKeyword) {
        return (Specification<TbComCodeGroup>) ((root, query, builder) -> {
    ...
    private static List<Predicate> getPredicateWithKeyword(Map<SearchKey, Object> searchKeyword,
            Root<TbComCodeGroup> root, CriteriaBuilder builder) {
