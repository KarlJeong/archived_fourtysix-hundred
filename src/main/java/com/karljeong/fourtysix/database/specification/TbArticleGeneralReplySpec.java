...
public class TbArticleGeneralReplySpec {
	...
	public static Specification<TbArticleGeneralReply> searchWithKeys(Map<SearchKey, Object> searchKeys) {
		return (Specification<TbArticleGeneralReply>) ((root, query, builder) -> {
	...
	private static List<Predicate> getPredicateWithKeyword(Map<SearchKey, Object> searchKeyword,
			Root<TbArticleGeneralReply> root, CriteriaBuilder builder) {
