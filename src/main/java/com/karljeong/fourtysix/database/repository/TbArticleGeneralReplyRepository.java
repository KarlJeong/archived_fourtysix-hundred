...
public interface TbArticleGeneralReplyRepository extends PagingAndSortingRepository<TbArticleGeneralReply, BigInteger>,
	...
	@Transactional
	@Modifying
	@Query(value = "INSERT INTO TB_ARTICLE_GENERAL_REPLY (CREATE_USER_ID, ARTICLE_ID, PRIOR_REPLY_ID, REPLY_CONTENTS, REPLY_LEVEL, REPLY_ORDER, REPLY_WRITER_ID) "
			...
			+ "     , :#{#tbArticleGeneralReply.replyWriterId} " + "FROM TB_ARTICLE_GENERAL_REPLY C "
