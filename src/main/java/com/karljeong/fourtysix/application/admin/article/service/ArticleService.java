...
public class ArticleService {
	...
	public TbComArticle create(TbComArticle tbComArticle) {
		tbComArticle.setCreateUserId(BigInteger.valueOf(1));
		tbComArticle.setArticleWriterId(BigInteger.valueOf(1));
		return tbComArticleRepository.save(tbComArticle);

	}

	public TbComArticle update(TbComArticle tbComArticle) {
		tbComArticle.setUpdateUserId(BigInteger.valueOf(1));
		tbComArticle.setArticleModifierId(BigInteger.valueOf(1));
		return tbComArticleRepository.save(tbComArticle);
