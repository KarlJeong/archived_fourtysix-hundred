...
public class MyArticleController {
	...
	public String viewMain(Model model, @RequestParam(required = false) Map<String, Object> searchRequest,
		...
		List<Map<String, Object>> articleCodeList = (List<Map<String, Object>>) loadStatic.getSystemCode()
				.get("ARTICLE_CODE").get("code");
		if (authService.findUserAuth(UserUtil.getUserId(), BigInteger.valueOf(18)) == null) {
